    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl bg-slate-900 p-6 text-white shadow-xl">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <button
            type="button"
            disabled={!canWriteDebt}
            onClick={() => setActiveModalOp("profile")}
            className="flex items-center gap-1.5 rounded-xl bg-slate-800 px-3.5 py-2 text-xs font-bold text-slate-300 hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
