...
export function translateDebtError(error: unknown): string {
  if (error instanceof Error) {
    ...
    const translations: Record<string, string> = {
      ...
      CREDIT_CARD_PROFILE_NOT_FOUND: "No se encontró la configuración de la tarjeta de crédito.",
      INVALID_CREDIT_CARD_PROFILE: "Los datos de configuración de la tarjeta de crédito no son válidos.",
      DEBT_NOT_CREDIT_CARD: "La deuda especificada no es una tarjeta de crédito.",
      INVALID_CREDIT_CARD_PURCHASE: "Los datos de la compra no son válidos.",
      INVALID_CREDIT_CARD_PAYMENT: "Los datos del pago de tarjeta no son válidos.",
      INVALID_CREDIT_CARD_STATEMENT: "Los datos del cierre de estado de cuenta no son válidos.",
      INVALID_CREDIT_CARD_FEE: "Los datos de la comisión o interés no son válidos.",
      INVALID_CREDIT_CARD_CREDIT: "Los datos de la devolución o reembolso no son válidos.",
      INVALID_CREDIT_CARD_REVERSAL: "Los datos del reverso no son válidos.",
      TARGET_ENTRY_NOT_FOUND: "No se encontró el registro destino seleccionado.",
      REVERSAL_TARGET_INVALID: "El registro seleccionado no admite reverso.",
      TARGET_ALREADY_REVERSED: "Este registro ya ha sido revertido previamente.",
      CREDIT_CARD_CREDIT_TARGET_INVALID: "El registro seleccionado no admite reembolsos.",
      CREDIT_CARD_REFUND_EXCEEDS_TARGET: "El monto del reembolso supera el saldo disponible del registro original.",
      CREDIT_CARD_TARGET_HAS_EFFECTIVE_CREDITS: "No se puede revertir un registro que ya tiene reembolsos activos.",
      ACCOUNT_NOT_FOUND: "La cuenta seleccionada no existe.",
      ACCOUNT_INACTIVE: "La cuenta seleccionada no está activa.",
      ACCOUNT_CURRENCY_MISMATCH: "La moneda de la cuenta debe coincidir con la moneda de la tarjeta de crédito.",
    };
